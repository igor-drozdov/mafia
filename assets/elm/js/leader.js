...
var _user$project$Player$Model = function (a) {
	return {name: a};
};

var _user$project$Leader_Init$viewPlayer = function (player) {
	return A2(
...
var _user$project$Leader_Init$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Play') {
			return A2(
			...
			var followerMessageDecoder = A2(
				_elm_lang$core$Json_Decode$map,
				_user$project$Player$Model,
				A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
			var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, followerMessageDecoder, _p0._0);
			if (_p1.ctor === 'Ok') {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							players: {ctor: '::', _0: _p1._0, _1: model.players}
						}),
					{ctor: '[]'});
			} else {
...
var _user$project$Leader_Init$Model = function (a) {
	return {players: a};
};
var _user$project$Leader_Init$init = _user$project$Leader_Init$Model(
	{ctor: '[]'});
var _user$project$Leader_Init$FollowerJoined = function (a) {
	return {ctor: 'FollowerJoined', _0: a};
};
var _user$project$Leader_Init$Play = {ctor: 'Play'};
var _user$project$Leader_Init$view = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$Leader_Init$viewPlayer, _p3.players)),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Leader_Init$Play),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Leader_Current$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{ctor: '[]'});
};
var _user$project$Leader_Current$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Leader_Current$Model = function (a) {
	return {players: a};
};
var _user$project$Leader_Current$init = _user$project$Leader_Current$Model(
	{ctor: '[]'});
var _user$project$Leader_Current$NoOp = {ctor: 'NoOp'};

var _user$project$Leader_Finished$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{ctor: '[]'});
};
var _user$project$Leader_Finished$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Leader_Finished$Model = function (a) {
	return {players: a};
};
var _user$project$Leader_Finished$init = _user$project$Leader_Finished$Model(
	{ctor: '[]'});
var _user$project$Leader_Finished$NoOp = {ctor: 'NoOp'};

var _user$project$Leader$userParams = _elm_lang$core$Json_Encode$object(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$Leader$socketServer = 'ws://localhost:4000/socket/websocket';
var _user$project$Leader$Flags = function (a) {
	return {gameId: a};
};
var _user$project$Leader$Model = F5(
	function (a, b, c, d, e) {
		return {state: a, initModel: b, currentModel: c, finishedModel: d, phxSocket: e};
	});
var _user$project$Leader$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Leader$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$Leader$PhoenixMsg);
};
var _user$project$Leader$FinishedMsg = function (a) {
	return {ctor: 'FinishedMsg', _0: a};
};
var _user$project$Leader$CurrentMsg = function (a) {
	return {ctor: 'CurrentMsg', _0: a};
};
var _user$project$Leader$InitMsg = function (a) {
	return {ctor: 'InitMsg', _0: a};
};
var _user$project$Leader$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'PhoenixMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{phxSocket: phxSocket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Leader$PhoenixMsg, phxCmd)
				};
			case 'InitMsg':
				var _p2 = A2(_user$project$Leader_Init$update, _p0._0, model.initModel);
				var subMdl = _p2._0;
				var subCmd = _p2._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Leader$InitMsg, subCmd),
						_1: {ctor: '[]'}
					});
			case 'CurrentMsg':
				var _p3 = A2(_user$project$Leader_Current$update, _p0._0, model.currentModel);
				var subMdl = _p3._0;
				var subCmd = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Leader$CurrentMsg, subCmd),
						_1: {ctor: '[]'}
					});
			default:
				var _p4 = A2(_user$project$Leader_Finished$update, _p0._0, model.finishedModel);
				var subMdl = _p4._0;
				var subCmd = _p4._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{finishedModel: subMdl}),
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Leader$FinishedMsg, subCmd),
						_1: {ctor: '[]'}
					});
		}
	});
var _user$project$Leader$view = function (model) {
	var _p5 = model.state;
	switch (_p5.ctor) {
		case 'Loading':
			return A2(
		...
		case 'Init':
			return A2(
				...
				_user$project$Leader$InitMsg,
				_user$project$Leader_Init$view(model.initModel));
		case 'Current':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Leader$CurrentMsg,
				_user$project$Leader_Current$view(model.currentModel));
		default:
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Leader$FinishedMsg,
				_user$project$Leader_Finished$view(model.finishedModel));
	}
};
var _user$project$Leader$Finished = {ctor: 'Finished'};
var _user$project$Leader$Current = {ctor: 'Current'};
var _user$project$Leader$Init = {ctor: 'Init'};
var _user$project$Leader$Loading = {ctor: 'Loading'};
var _user$project$Leader$init = function (_p6) {
	var _p7 = _p6;
	var _p9 = _p7.gameId;
	var initPhxSocket = _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$Leader$socketServer));
	var channel = A2(
		_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
		_user$project$Leader$userParams,
		_fbonetti$elm_phoenix_socket$Phoenix_Channel$init(
			A2(_elm_lang$core$Basics_ops['++'], 'rooms:leader:', _p9)));
	var _p8 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, initPhxSocket);
	var phxSocket = _p8._0;
	var phxCmd = _p8._1;
	var phxSocketWithListener = A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'follower_joined',
		A2(_elm_lang$core$Basics_ops['++'], 'rooms:leader:', _p9),
		_user$project$Leader_Init$FollowerJoined,
		phxSocket);
	var initModel = {
		state: _user$project$Leader$Loading,
		initModel: _user$project$Leader_Init$init,
		currentModel: _user$project$Leader_Current$init,
		finishedModel: _user$project$Leader_Finished$init,
		phxSocket: A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$map, _user$project$Leader$InitMsg, phxSocketWithListener)
	};
	return {
		ctor: '_Tuple2',
		_0: initModel,
...
var _user$project$Leader$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Leader$init, update: _user$project$Leader$update, view: _user$project$Leader$view, subscriptions: _user$project$Leader$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (gameId) {
...
var Elm = {};
Elm['Leader'] = Elm['Leader'] || {};
if (typeof _user$project$Leader$main !== 'undefined') {
    _user$project$Leader$main(Elm['Leader'], 'Leader', undefined);
}
