...
init { gameId, playerId } =
    let
        ...
        phxSocketWithListener =
            phxSocket
                |> Phoenix.Socket.on "follower_joined" ("rooms:followers:" ++ gameId) (Init.FollowerJoined >> InitMsg)
                |> Phoenix.Socket.on "follower_left" ("rooms:followers:" ++ gameId) (Current.Agree >> CurrentMsg)
